  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="allmenu">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          <a href="javascript:;">医药管理</a>
          <dl class="layui-nav-child">
            <dd><a href="javascript:;" data-url="${pageContext.request.contextPath}/medicine/listMedicine.jsp" data-id="browseUser1">药品列表</a></dd>
            <dd><a href="javascript:;" data-url='${pageContext.request.contextPath}/medicine/addMedicine.jsp' data-id="addUser1">添加药品</a></dd>
            <dd><a href="javascript:;">权限列表</a></dd>
            <dd><a href="javascript:;">权限分配</a></dd>
          </dl>
        </li>
    ...
    <div style="padding: 15px;">
				<div class="layui-tab" lay-allowClose="true" lay-filter="card">
					...
					<div class="layui-tab-content">
						<div class="layui-tab-item layui-show"><iframe src="${pageContext.request.contextPath}/medicine/listMedicine.jsp" id="demoAdmin" style="width: 100%; height: 800px;" frameborder="0"></iframe>  </div>
					</div>
				</div>
